...
const productSchema = {
  ...
  name: "Portable Toilet Unit 130x130cm - Welfare Cabin",
  description:
    "Complete portable toilet unit with flushing toilet, wash basin, and full plumbing connections for welfare facilities. Fully insulated 130×130cm modular design perfect for outdoor events, festivals, and industrial sites.",
