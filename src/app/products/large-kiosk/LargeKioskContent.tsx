...
const LargeKioskPage = () => {
  ...
  const specs = [
    { icon: Ruler, name: 'Dimensions', value: '218 × 143 cm' },
    { icon: Ruler, name: 'Interior Height', value: '2.10 meters' },
    { icon: Ruler, name: 'Window Dimensions', value: 'W128×H80 cm, foldable window W128×H40 cm' },
    { icon: Ruler, name: 'Weight', value: '400 kg approx.' },
    ...
    <div className="bg-gray-50 min-h-screen pt-16">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="flex text-sm">
            ...
            <ChevronRight className="w-4 h-4 mx-2 text-gray-400" />
            <span className="text-gray-900 font-medium">Large Modular Kiosk</span>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-12">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Large Modular Kiosk</h1>
            <p className="text-gray-600 mb-4">Ticket Booth | Security Cabin | Gate House</p>
            ...
            <div className="bg-blue-50 rounded-lg p-4 mb-6 border border-blue-100">
              <p className="text-blue-800 text-sm">
                Brand new, strong and durable, fully insulated modular kiosk with dimensions of 218×143 cm.
                Perfect for versatile applications and built with premium materials to EU standards for durability in all weather conditions.
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="prose prose-blue max-w-none text-gray-700">
                    <p>
                      Our Large Modular Kiosk is brand new, strong, and durable, fully insulated with dimensions of 218×143 cm. 
            ...
            {activeTab === 'applications' && (
              <div>
                ...
                <p className="text-gray-700 mb-8">
                  The Large Modular Kiosk can be utilized in numerous ways and is an ideal solution for many outdoor events 
                ...
                <div className="mt-10 bg-blue-50 rounded-lg p-6 border border-blue-100">
                  ...
                  <p className="text-blue-800">
                    Our Large Modular Kiosk can be customized to meet your specific requirements. 
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="md:flex items-center justify-between">
            <div className="mb-6 md:mb-0 md:mr-8">
              <h2 className="text-2xl font-bold mb-2">Ready to learn more about our Large Modular Kiosk?</h2>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="prose prose-blue max-w-none text-gray-600 text-sm">
          <h2>Kiosk Ticket Booth Security Portable Cabin Modular Gate House Carpark Hut</h2>
          <p>
            Our Large Modular Kiosk is a brand new, strong and durable, fully insulated unit measuring 218×143 cm. 
          ...
          <p>
            The Large Modular Kiosk features outer dimensions of 2.18 meters × 1.43 meters with an interior height of 2.10 meters. 
            It includes windows measuring W128×H80 cm and a foldable window measuring W128×H40 cm with upward sliding and fixed options. 
            The unit weighs approximately 400 kg.
          </p>
          <p>
